...
export const NOTES = {
  IMAGES:
    "J'ai implémenté une gestion totale des fichiers image. Tu n'as donc à te soucier ni de la taille du fichier ni" +
    " de la dimension de l'image. C'est redimensionné de manière à garder des dimensions minimum pour l'affichage" +
    " sur grand écran (2000 pixels de large) et c'est optimisé pour garder le plus de qualité possible dans cette" +
    " dimension. En revanche, il est évident que si tu fournis une image plus petite que 2000 px de large ou de" +
    " mauvaise qualité, ça le restera. À noter que ça prend aussi les fichiers png",
  THEMES:
